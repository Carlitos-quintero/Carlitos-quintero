...
<br><br>
<p>
Soy Carlos Andrés Quintero Becerra, desarrollador apasionado por construir soluciones digitales que combinan funcionalidad, diseño y rendimiento. Disfruto transformar ideas en productos útiles, con un enfoque en la calidad del código y la experiencia del usuario.
</p>

<p>
Cuento con formación en Programación de Software en el Politécnico PIO, donde completé mis prácticas aplicando un stack que incluye JavaScript, TypeScript, Node.js, React, MongoDB, PostgreSQL y otras tecnologías. Mi experiencia abarca desde el desarrollo frontend y backend, hasta la implementación de bases de datos y la integración de APIs.
</p>
<img align="right" alt="Coding" width="400" src="https://github.com/supravatm/supravatm/blob/main/src/code.gif">
<p>
	He participado en proyectos que van desde sistemas de logística y automatización de procesos, hasta plataformas web para marketing y gestión empresarial. Esta trayectoria me ha permitido fortalecer mis habilidades de análisis, resolución de problemas y trabajo en equipo, manteniendo siempre una mentalidad de mejora continua.
</p>
<p>
 Mi meta es seguir creciendo como profesional, contribuyendo a proyectos que no solo cumplan con los objetivos, sino que generen un impacto positivo y real en quienes los usan.
</p>
...
<table>
  <tr align="center">
      ...
      <td><img src="https://skillicons.dev/icons?i=c" width="50"><br><p>C</p></td>
...
<table>
  ...
  <tr>
    <td width="1100" valign="top">
      <h3 align="center">Ecomerce_Game</h3>
        <br />
        <a target="_blank" href="https://github.com/Carlitos-quintero/Ecomerce_Game-V.3">
         <img src="https://github.com/Carlitos-quintero/Ecomerce_Game-V.3/blob/main/frontend/public/Catalogo.jpeg" width="100%" height="500" alt="App"/>   
        </a>
        <br />
        <p align="center">
		<a href="https://github.com/Carlitos-quintero/Ecomerce_Game-V.3" target="_blank">
